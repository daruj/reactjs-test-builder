...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoInput = __webpack_require__(161);
	var TodoList = __webpack_require__(162);
	    ...
	    render: function(){
	        return (
	            React.createElement("div", null, 
	                React.createElement("h1", null, "TODO PAGE"), 
	                React.createElement(TodoInput, {onAdd: this.addItem}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TodoElement = __webpack_require__(163);
	...
	var TodoList = React.createClass({displayName: "TodoList",
	    render: function() {
	        ...
	        return (
	            React.createElement("div", null, React.createElement("ul", {style: JSON.parse(JSON.stringify(elementStyles))}, 
	                this.props.items.map(function(item,index) {
	                    return React.createElement(TodoElement, {removeItem: _self.props.removeItem.bind(null,index), key: index, value: item});
	                })
	            )))
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoElement = React.createClass({displayName: "TodoElement",
	    ...
	    render: function() {
	        return (
	            React.createElement("li", {style: elementStyle}, 
	                React.createElement("span", null, this.props.value), 
	                React.createElement("span", {onClick: this.deleteItem, style: removeItemStyles}, "X")
	            )
	        )
	    }
	});
