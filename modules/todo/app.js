...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoInput = __webpack_require__(166);
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function addItem(value) {
	            this.setState({
	                items: (0, _reactAddonsUpdate2.default)(this.state.items, { $push: [value] })
	            });
	        }
	    }, {
	        key: 'removeItem',
	        value: function removeItem(index) {
	            this.setState({
	                items: (0, _reactAddonsUpdate2.default)(this.state.items, { $splice: [[index, 1]] })
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_todoInput2.default, { onAdd: function onAdd(value) {
	                        return _this2.addItem(value);
	                    } }),
	                _react2.default.createElement(_todoList2.default, { items: this.state.items, removeItem: function removeItem() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoInput = function (_React$Component) {
	    ...
	    function TodoInput(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoInput).call(this, props));
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', {
	                    ...
	                    onChange: function onChange() {
	                        return _this2.updateValue(_this2.refs.todoInput.value);
	                    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoElement = __webpack_require__(168);
	    ...
	    _createClass(TodoList, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { style: JSON.parse(JSON.stringify(elementStyles)) },
	                    this.props.items.map(function (item, index) {
	                        return _react2.default.createElement(_todoElement2.default, { removeItem: function removeItem() {
	                                return _self.props.removeItem(index);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoElement = function (_React$Component) {
	    ...
	    function TodoElement(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoElement).call(this, props));
