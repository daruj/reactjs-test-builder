...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productTable = __webpack_require__(161);
	...
	var data = _immutable2.default.List.of({ category: "Sporting Goods", price: "$49.99", stocked: true, name: "Football" }, { category: "Sporting Goods", price: "$9.99", stocked: true, name: "Baseball" }, { category: "Sporting Goods", price: "$29.99", stocked: false, name: "Basketball" }, { category: "Electronics", price: "$99.99", stocked: true, name: "iPod Touch" }, { category: "Electronics", price: "$399.99", stocked: false, name: "iPhone 5" }, { category: "Electronics", price: "$199.99", stocked: true, name: "Nexus 7" });
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        key: 'filterData',
	        value: function filterData(value) {
	            var stocked = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];

	            this.setState({
	                data: stocked ? data.filter(function (x) {
	                    return x.name.toLowerCase().search(value.toLocaleLowerCase()) !== -1 && x.stocked == stocked;
	                }) : data.filter(function (x) {
	                    return x.name.toLocaleLowerCase().search(value.toLocaleLowerCase()) !== -1;
	                })
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_searchBar2.default, { onFilter: function onFilter(v, s) {
	                        return _this2.filterData(v, s);
	                    } }),
	                _react2.default.createElement(_productTable2.default, { items: this.state.data })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = function (_React$Component) {
	    ...
	    _createClass(SearchBar, [{
	        key: 'search',
	        value: function search(value, stocked) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'text',
	                    ...
	                    onChange: function onChange() {
	                        return _this2.search(_this2.refs.searchInput.value, _this2.refs.filterByStock.checked);
	                    },
	                    placeholder: 'Search...',
	                    ref: 'searchInput',
	                    style: inputStyles }),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement('input', { type: 'checkbox', value: '', ref: 'filterByStock', onClick: function onClick() {
	                                return _this2.search(_this2.refs.searchInput.value, _this2.refs.filterByStock.checked);
	                            } }),
	                        _react2.default.createElement(
	                            'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductTable = function (_React$Component) {
	    ...
	    function ProductTable(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProductTable).call(this, props));
	    ...
	    _createClass(ProductTable, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'table',
	                { style: styles },
	                _react2.default.createElement(_productTableHeader2.default, null),
	                _react2.default.createElement(
	                    'tbody',
	                    null,
	                    this.props.items.map(function (item, index) {
	                        return _react2.default.createElement(_productRow2.default, { key: index, item: item });
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductRow = function (_React$Component) {
	    ...
	    function ProductRow(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProductRow).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductTableHeader = function (_React$Component) {
	    _inherits(ProductTableHeader, _React$Component);

	    function ProductTableHeader(props) {
	        _classCallCheck(this, ProductTableHeader);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProductTableHeader).call(this, props));
	...
	exports.default = ProductTableHeader;
